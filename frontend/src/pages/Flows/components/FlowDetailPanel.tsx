...
import { FiLayers, FiSettings, FiCpu, FiTrash2, FiCopy } from 'react-icons/fi';
import { useNavigate } from 'react-router-dom';
import { fetchFlowGraph, type FlowApi } from '../../../api/flows';
...
const FlowDetailPanel: React.FC<FlowDetailPanelProps> = ({ flow, onDelete, onDuplicate }) => {
                    ...
                    <div className="flex items-start gap-6 border-b border-white/5 pb-8">
                        ...
                        <div className="pt-1">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <span className="text-[10px] font-mono text-slate-500 uppercase tracking-widest">Ver. {flow.version}.0</span>
                            </div>
                        ...
                        <div className="bg-black/40 border border-white/10 rounded-none relative">
                            ...
                            <div className="grid grid-cols-2 divide-x divide-white/5">
                                ...
                                <div className="p-4 border-b border-white/5 flex justify-between items-center group hover:bg-white/[0.02] transition-colors cursor-default">
                                    ...
                                    <span className="text-xs font-bold font-mono text-emerald-400">V{flow.version}.0.0</span>
                                </div>
                                <div className="p-4 border-b border-white/5 flex justify-between items-center group hover:bg-white/[0.02] transition-colors cursor-default">
